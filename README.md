...
The webinars publicly available: 
...
* [Global 30-m resolution ensemble digital terrain model and vegetation height datasets 2000–2022 based on ICESat-2, GEDI and spatiotemporal ML](https://youtu.be/dHAudnlLGbI)
* [Machine Learning methods for census data: lessons learned from mapping global livestock dynamics at 1 km resolution 2000–2022](https://youtu.be/zMCvicl51C4)


## Acknowledgements & Funding

This work is conducted by [WRI](https://wri.org), [OpenGeoHub Foundation](https://opengeohub.org/), [LAPIG/UFG](http://lapig.iesa.ufg.br), [IIASA](https://iiasa.ac.at/) and [iDiv](https://www.idiv.de/en/index.html) and has received funding from [Land and Carbon Lab](https://www.landcarbonlab.org/), via the [Global Pasture Watch](https://www.wri.org/events/2023/4/global-pasture-watch-mapping-monitoring-global-grasslands-livestock), and European Union’s Horizon Europe research and innovation program, via the [Open-Earth-Monitor Cyberinfrastructure project](https://earthmonitor.org), under grant agreement [No. 101059548](https://cordis.europa.eu/project/id/101059548)